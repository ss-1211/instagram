...
class HomeViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        tableView.estimatedRowHeight = UIScreen.main.bounds.width + 50
    }
    ...
    @objc func handleComment(_ sender: UIButton, forEvent event: UIEvent) {
        ...
        print(postData)
        let commentPostViewController = storyboard?.instantiateViewController(withIdentifier: "CommentPost") as! CommentPostViewController
        commentPostViewController.postArray = postData
